...
let numberingObj = require ("./numbering");
let bigBreakObj = require ("./bigbreak");
let breakNumObj = require ("./breaknum");
...
switch (cmd) {
 case "-s":
     bigBreakObj.bbreakFn(input[1]);
     break;
 case "-n":
     numberingObj.numberFn(input[1]);
     break;
 case "-b":
      breakNumObj.bnumFn(input[1]);
      break;
 default: 
      readObj.readFn(input[0]);
      break;
